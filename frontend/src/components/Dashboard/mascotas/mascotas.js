...
export default class users extends Component {
    ...
    eliminarusuario(id) {
        if (window.confirm('¿Estas seguro de eliminar esta mascota?')) {
            ...
            fetch(`http://localhost:4000mascotas/_id/${id}`, envio)
    ...
    listar = (e) => {
        ...
        console.log()
        fetch('http://localhost:4000mascotas/', envio)
            .then(response => {
                if (response.ok) {
                    return response.json()
                }
    ...
    UserNew = (e) => {
        ...
        if (this.especie === undefined) {
            ...
            fetch('http://localhost:4000mascotas/register', envio)
                .then(response => {
                    if (response.ok) {
                        return response.json()
                    }
    ...
    actualizar2 = (e) => {
        ...
        if (this.name === undefined) {
            ...
            console.log(envio)
            fetch(`http://localhost:4000mascotas/_id/${id_d}`, envio)
                .then(response => {
                    if (response.ok) {
                        return response.json()
                    }
